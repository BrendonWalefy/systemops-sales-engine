...
// Gateway puro: texto → bytes de áudio. A normalização para fala é responsabilidade
// do NormalizingTtsGateway (decorator aplicado pela fábrica), não deste adapter.
