...
describe("performance telemetry route", () => {
  ...
  it("rejects malformed, unknown-field, non-client, and non-allowed-operation payloads", async () => {
  ...
  it("accepts client payloads with content_ready and app_first_open operations", async () => {
