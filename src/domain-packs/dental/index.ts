...
import { createDentalCatalogCapability, createDentalEscalationCapability, createDentalSchedulingCapability, type DentalPolicy } from "@/domain-packs/dental/capabilities";
...
}): DomainPack<DentalRequest, DentalPolicy> {
  return {
    id: "dental",
    capabilities: [
      createDentalCatalogCapability(ports.catalogRead),
      createDentalSchedulingCapability(ports.schedulingRead, ports.schedulingWrite),
      createDentalEscalationCapability(),
    ],
    journeys: [
      { id: "price", capabilityIds: ["dental-catalog", "dental-escalation"] },
      { id: "availability", capabilityIds: ["dental-catalog", "dental-escalation"] },
...
export const dentalPack = createDentalPack({
  ...
  schedulingRead: { listSlots: unavailable, resolveOfferedSlot: unavailable, resolvePendingAppointment: unavailable },
