        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(96px, 1fr))", gap: "12px", marginBottom: "20px" }}>
            <div style={{ minWidth: 0, border: "1px solid var(--line)", borderRadius: "10px", padding: "14px 16px", background: "var(--surface-raised)" }}>
              ...
              <strong style={{ display: "block", fontSize: "22px", fontWeight: 800, color: "var(--accent-strong)", lineHeight: 1.1, wordBreak: "break-word" }}>
            ...
            <div style={{ minWidth: 0, border: "1px solid var(--line)", borderRadius: "10px", padding: "14px 16px", background: "var(--surface-raised)" }}>
              ...
              <strong style={{ display: "block", fontSize: "22px", fontWeight: 800, color: "var(--text)", lineHeight: 1.1, wordBreak: "break-word" }}>
