  ...
  const [clinic, versions, treatments, activeModules, memberProfile, campaigns] = await Promise.all([
    db
      .select({
        ...
        conversationRestartHours: organizations.conversationRestartHours,
        ...
        paymentMethods: organizations.paymentMethods,
  ...
  return (
    <IASettingsClient
      clinic={{
        ...
        conversationRestartHours: clinic?.conversationRestartHours ?? 24,
