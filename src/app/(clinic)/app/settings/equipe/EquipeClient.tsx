...
import { CheckCircle2, Loader2, Plus, Trash2, UserCircle2 } from "lucide-react";
import { addMember, removeMember, type EquipeActionState } from "./actions";
            ...
            {members.map((m, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p style={{ margin: 0, fontSize: "14px", fontWeight: 600 }}>{m.email}</p>
                    {prof && (
                      <p style={{ margin: "2px 0 0", fontSize: "12px", color: "var(--muted)" }}>{prof.name}</p>
                    )}
                  </div>
