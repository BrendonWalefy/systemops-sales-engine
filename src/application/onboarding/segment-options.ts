...
export const SEGMENT_DEFAULTS: Record<SegmentKey, SegmentDefaults> = {
  dental: {
    ...
    greetingPlaceholder: "Olá! Sou a especialista comercial com IA da clínica. Como posso ajudar?",
  ...
  barbershop: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da barbearia. Qual serviço você procura?",
  ...
  atelier: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA do ateliê. Como posso ajudar com seu pedido?",
  ...
  cortinas: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da loja. Quer ajuda com cortinas ou persianas?",
  ...
  retail: {
    ...
    toneOfVoice: "profissional",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da loja. Como posso ajudar?",
  ...
  pet_services: {
    ...
    toneOfVoice: "acolhedor",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA do pet shop. Como posso ajudar você e seu pet?",
  ...
  fitness: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA do studio. Quer ver horários ou planos?",
  ...
  education: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da escola. Quer saber sobre qual curso?",
  ...
  real_estate: {
    ...
    businessHours: "Seg-Sex 09:00-18:00, Sab 09:00-13:00",
    toneOfVoice: "consultivo",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da imobiliária. Procura comprar, vender ou alugar?",
  ...
  professional_services: {
    ...
    businessHours: "Seg-Sex 09:00-18:00",
    toneOfVoice: "profissional",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da empresa. Como posso ajudar?",
  ...
  automotive: {
    ...
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA da oficina. Qual serviço você precisa?",
  ...
  events: {
    ...
    businessHours: "Seg-Sex 09:00-18:00",
    toneOfVoice: "consultivo",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA de eventos. Quer falar sobre qual data ou formato?",
  ...
  restaurant: {
    ...
    toneOfVoice: "amigavel",
    greetingPlaceholder: "Olá! Sou o especialista comercial com IA do restaurante. Quer fazer uma reserva ou tirar uma dúvida?",
