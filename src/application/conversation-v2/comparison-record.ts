...
export const COMPARISON_CAPABILITY_IDS = [
  "dental-knowledge", "dental-playbook-knowledge", "dental-explanation", "dental-commercial", "dental-catalog", "dental-scheduling", "dental-appointment-lifecycle", "dental-journey", "dental-operations", "dental-escalation", "dental-reception",
] as const;
